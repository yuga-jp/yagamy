...
List<SearcherProp> getSearcherPropList(
    String categoryMain, String categorySub, String area, String floor) {
  List<SearcherProp> propList = [];
  SearcherProp? propCategoryMain = getSearcherPropCategory(categoryMain);
  SearcherProp? propCategorySub = getSearcherPropCategory(categorySub);
  SearcherProp propPlace = getSearcherPropPlace(area, floor);
...
SearcherProp? getSearcherPropCategory(String value) {
...
SearcherProp getSearcherPropPlace(String area, String floor) {
