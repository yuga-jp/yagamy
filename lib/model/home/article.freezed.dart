...
abstract class $ArticleCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String body, String thumbnailUrl});
}
...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, title: $title, body: $body, thumbnailUrl: $thumbnailUrl)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, body, thumbnailUrl);
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      required final String thumbnailUrl}) = _$_Article;
