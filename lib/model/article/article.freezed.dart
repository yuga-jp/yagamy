...
abstract class $ArticleCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String title, String body, String thumbnailUrl, String url});
}
...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, title: $title, body: $body, thumbnailUrl: $thumbnailUrl, url: $url)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, body, thumbnailUrl, url);
