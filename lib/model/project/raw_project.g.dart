...
_$_RawProject _$$_RawProjectFromJson(Map<String, dynamic> json) =>
    _$_RawProject(
      ...
      hoursStartFirstDay: DateTime.parse(json['hoursStartFirstDay'] as String),
      hoursEndFirstday: DateTime.parse(json['hoursEndFirstday'] as String),
      hoursStartSecondDay:
          DateTime.parse(json['hoursStartSecondDay'] as String),
      hoursEndSecondDay: DateTime.parse(json['hoursEndSecondDay'] as String),
