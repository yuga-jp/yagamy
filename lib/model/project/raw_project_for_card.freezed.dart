...
mixin _$RawProjectForCard {
  ...
  @JsonKey(ignore: true)
  $RawProjectForCardCopyWith<RawProjectForCard> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RawProjectForCardCopyWith<$Res> {
  factory $RawProjectForCardCopyWith(
          RawProjectForCard value, $Res Function(RawProjectForCard) then) =
      _$RawProjectForCardCopyWithImpl<$Res, RawProjectForCard>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$RawProjectForCardCopyWithImpl<$Res, $Val extends RawProjectForCard>
    implements $RawProjectForCardCopyWith<$Res> {
  _$RawProjectForCardCopyWithImpl(this._value, this._then);
...
abstract class _RawProjectForCard implements RawProjectForCard {
  const factory _RawProjectForCard(
